...
namespace Ceci.Test.Fakers.Address
{
    public static class AddressFaker
    {
        public static Faker<Ceci.Domain.Entities.Address> AddressEntity()
        {
            return new Faker<Ceci.Domain.Entities.Address>()
                .CustomInstantiator(p => new Ceci.Domain.Entities.Address
                {
                    Id = p.Random.Int(),
